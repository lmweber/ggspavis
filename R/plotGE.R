...
#'   = FALSE.
#' @param Visium  (logical) Whether to show histology image as background as in \link{plotVisium}. Default
#'   = FALSE.
#' @param ... Other arguments for \link{plotVisium} and \link{plotSpots}
#'
